...
public class GeminiService {
    ...
    public String generateMongoQuery(String question) {
        ...
        Use ONLY the "teams" collection.
        Do NOT include explanations.
        Do NOT include markdown.
        Do NOT include backticks.
        Return ONLY pure JSON.
        Use correct MongoDB operators like $gt, $lt, $gte, $lte, $regex when needed.
        ...
        Notes:
        - establishYear, rank and budget are numbers.
        - name and city are strings.
        - status is an enum stored as string.
        - If searching by name or city, use case-insensitive regex.
